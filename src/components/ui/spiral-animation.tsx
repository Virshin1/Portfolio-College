...
class AnimationController {
  ...
  constructor(
    ...
    this.dpr = dpr
    this.size = size
    this.timeline = gsap.timeline({ repeat, onComplete })
    
    this.setupRandomGenerator()
    this.createStars()
    this.setupTimeline(duration, repeat)
  }
  ...
  private setupTimeline(duration: number, repeat: number) {
    this.timeline
      .to(this, {
        time: 1,
        duration: duration,
...
export function SpiralAnimation({ 
  ...
  useEffect(() => {
    ...
    animationRef.current = new AnimationController(canvas, ctx, dpr, size, duration, repeat, onComplete)
  ...
  }, [dimensions, duration, repeat, onComplete])
